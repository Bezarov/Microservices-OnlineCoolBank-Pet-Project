package com.example.securitycomponent.filter;
...
public class JwksProvider {
    ...
    public JwksProvider(JwtUtil jwtUtil) {
        this.jwtUtil = jwtUtil;
    }


    public void cacheInitKeys() {
        LOGGER.info("Initializing JWKS public keys from JWTUtils on startup");
        JwksSpecificInfoDTO jwks = jwtUtil.getJwksSpecificInfo();
