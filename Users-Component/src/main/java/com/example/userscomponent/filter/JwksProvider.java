package com.example.userscomponent.filter;
...
public class JwksProvider {
    ...
    public JwksProvider(@Qualifier("Security-Components") SecurityComponentClient securityComponentClient, UsersAppComponentConfig usersConfig) {
