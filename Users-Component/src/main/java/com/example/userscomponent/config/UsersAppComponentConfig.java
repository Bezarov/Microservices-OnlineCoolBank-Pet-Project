...
@Component
public class UsersAppComponentConfig {
    ...
    public UsersAppComponentConfig() {
    }

    public UsersAppComponentConfig(String componentName, UUID componentId, String componentSecret) {
    ...
    public String toString() {
        return "UsersAppComponentConfig{" +
