...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(@NonNull HttpServletRequest request,
        ...
        if (requestJwtToken != null && requestJwtToken.startsWith("Bearer ") && requestURI.startsWith("/components/")) {
            try {
                ...
                logger.error("Feign exception during authentication: " + feignResponseError.contentUTF8());
