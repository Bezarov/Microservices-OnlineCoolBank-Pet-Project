...
public class AppComponentServiceImpl implements AppComponentService {
    ...
    public AppComponentServiceImpl(AppComponentRepository appComponentRepository, PasswordEncoder passwordEncoder) {
    ...
    public AppComponent registerComponent(AppComponent appComponent) {
        ...
        matchedIncomingComponentInComponentConfig.setComponentSecret(passwordEncoder.encode(
                matchedIncomingComponentInComponentConfig.getComponentSecret()));
