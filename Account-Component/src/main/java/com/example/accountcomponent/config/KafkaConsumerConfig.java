...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, UUID> uuidConsumerFactory() {
        ...
        uuidConsumerProp.put(ConsumerConfig.GROUP_ID_CONFIG, uniqueAccountComponentGroupId);
    ...
    public ConsumerFactory<String, String> stringConsumerFactory() {
        ...
        stringConsumerProp.put(ConsumerConfig.GROUP_ID_CONFIG, uniqueAccountComponentGroupId);
    ...
    public ConsumerFactory<String, Map<Object, Object>> mapObjectToObjectConsumerFactory() {
        ...
        mapUUIDToObjectConsumerProp.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, kafkaBootstrapServers);
        mapUUIDToObjectConsumerProp.put(ConsumerConfig.GROUP_ID_CONFIG, uniqueAccountComponentGroupId);
