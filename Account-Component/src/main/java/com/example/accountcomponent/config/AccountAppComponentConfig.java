...
@Component
public class AccountAppComponentConfig {
    ...
    public AccountAppComponentConfig() {
    }

    public AccountAppComponentConfig(String componentName, UUID componentId, String componentSecret) {
    ...
    public String toString() {
        return "AccountAppComponentConfig{" +
