...
@Component
public class EurekaServerAppComponentConfig {
    ...
    public EurekaServerAppComponentConfig() {
    }

    public EurekaServerAppComponentConfig(String componentName, UUID componentId, String componentSecret) {
