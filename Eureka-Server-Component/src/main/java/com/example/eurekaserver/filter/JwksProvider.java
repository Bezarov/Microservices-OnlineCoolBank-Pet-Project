...
public class JwksProvider {
    ...
    public JwksProvider(@Qualifier("Security-Components") SecurityComponentClient securityComponentClient, EurekaServerAppComponentConfig eurekaServerConfig) {
    ...
    public void cacheInitKeys() {
        ...
        JwksSpecificInfoDTO jwks = securityComponentClient.getActualJwks(
                new AuthRequestDTO(eurekaServerConfig.getComponentId(), eurekaServerConfig.getComponentSecret()));
