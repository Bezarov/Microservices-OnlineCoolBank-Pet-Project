package com.example.cardcomponent.filter;
...
public class JwksProvider {
    ...
    public JwksProvider(@Qualifier("Security-Components") SecurityComponentClient securityComponentClient, CardAppComponentConfig cardConfig) {
