...
@Component
public class CardAppComponentConfig {
    ...
    public CardAppComponentConfig() {
    }

    public CardAppComponentConfig(String componentName, UUID componentId, String componentSecret) {
